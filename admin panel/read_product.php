...
<body>
    ...
    <div class="main-container">
        ...
        <section class="read-post">
            <div class="heading">
                <h1> products details</details></h1> 
            ...
            <div class="box-container">
                ...
                <form action="" method="post" class="box">
                    ...
                    <div class="content"><?= $fetch_product['product_id']; ?></div>
                    <div class="flex-btn">
                        <a href="edit_product.php?id=<?= $fetch_product['id']; ?>" class="btn">edit</a>
                        <button type="submit" name="delete" class="btn" onclick="return comfirm('delete this product');">delete</button>
